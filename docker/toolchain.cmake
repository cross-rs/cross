...
if(DEFINED ENV{CROSS_SYSROOT})
    cmake_path(CONVERT "$ENV{CMAKE_PREFIX_PATH}" TO_CMAKE_PATH_LIST ENV_CMAKE_PREFIX_PATH)
    set(CMAKE_FIND_ROOT_PATH "$ENV{CROSS_SYSROOT}" "${CMAKE_PREFIX_PATH}" "${ENV_CMAKE_PREFIX_PATH}")
